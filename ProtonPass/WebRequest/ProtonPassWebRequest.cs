...
{
    public sealed class ProtonPassWebRequest : System.Net.WebRequest
    {
        ...
        public ProtonPassWebRequest(ProtonDriveStorageProvider provider, string itemPath)
        {
        ...
        public override WebResponse GetResponse()
        {
            ...
            else if (this.Method == WebRequestMethods.Http.Post)
            {
                ...
                _response = new ProtonPassWebResponse();
            }
            else // Get File
            {
                ...
                _response = new ProtonPassWebResponse(memoryStream);
            }
