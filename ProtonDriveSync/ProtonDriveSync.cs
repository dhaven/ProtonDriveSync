...
{
    public sealed class ProtonDriveSyncExt : Plugin
    {
        ...
        public override bool Initialize(IPluginHost pluginHost)
        {
            ...
            if (fileMenu != null)
            {
                ...
                if (saveMenu != null)
                {
                    ...
                    _tsSaveToCloudDrive = new ToolStripMenuItem("Save to ProtonDrive...");
        ...
        private async Task<bool> HasAccounts()
        {
            ...
            var result = MessageService.Ask(
                "At least one account is required to work with ProtonDriveSync.\r\nWould you like to open ProtonDriveSync Settings to create a new account?",
                "ProtonDriveSync", MessageBoxButtons.YesNo);
        ...
        public override ToolStripMenuItem GetMenuItem(PluginMenuType t)
        {
            if (t == PluginMenuType.Main)
            {
                ...
                var tsShowSettings = new ToolStripMenuItem("ProtonDriveSync Settings...");
        ...
        {
            get { return @"https://raw.githubusercontent.com/dhaven/ProtonDriveSync/main/version_manifest.txt"; }
        }
    }
}
